...
// RegisterStatAppServiceHandlerServer registers the http handlers for service StatAppService to "mux".
// UnaryRPC     :call StatAppServiceServer directly.
...
// RegisterStatAppServiceHandlerFromEndpoint is same as RegisterStatAppServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterStatAppServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterStatAppServiceHandler(ctx, mux, conn)
}

// RegisterStatAppServiceHandler registers the http handlers for service StatAppService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterStatAppServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterStatAppServiceHandlerClient(ctx, mux, NewStatAppServiceClient(conn))
}

// RegisterStatAppServiceHandlerClient registers the http handlers for service StatAppService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "StatAppServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "StatAppServiceClient"
